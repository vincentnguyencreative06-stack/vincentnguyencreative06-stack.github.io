      ...
      <section className="shell editorial-grid section-pad-top">
        ...
        <div className="longform">
          ...
          <Reveal>
            ...
            <p>I am especially drawn to business transformation, process improvement and customer experience, which are problems where analysis matters only if people can understand and use it.</p>
          </Reveal>
          <Reveal>
