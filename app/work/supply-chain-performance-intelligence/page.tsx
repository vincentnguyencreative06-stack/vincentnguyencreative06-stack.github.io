        ...
        <div className="case-main">
          ...
          <Reveal as="section" className="case-section"><div id="findings" className="anchor" />
            ...
            <div className="finding-list">
              ...
              <article><span>Customer portfolio</span><h3>A small champion segment created most value.</h3><p>Across 675 customers, Champions represented 17.93% of customers yet 64.24% of value. Thirty-four customers—5.04%—were at risk of churning.</p></article>
